            ...
            <div class="form-control mt-2">
              ...
              {#if form.ecgQRS === 'wide'}
                ...
                <label class="flex items-center gap-3 cursor-pointer mt-2">
                  <input type="checkbox" bind:checked={form.ecgScarbossa} class="checkbox checkbox-sm checkbox-primary" />
      ...
      <div class="card bg-base-100 shadow-md border-l-4 border-warning">
        <div class="card-body">
          ...
          <div class="form-control">
            ...
            <label class="flex items-center gap-3 cursor-pointer mt-2">
              <input type="checkbox" bind:checked={form.aphasia} class="checkbox checkbox-primary" />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex flex-col gap-2 justify-end">
              <label class="flex items-center gap-3 cursor-pointer">
                <input type="checkbox" bind:checked={form.meningealSigns} class="checkbox checkbox-primary" />
                <span>{$_('medicalReport.disability.meningealSigns')}</span>
              </label>
              <label class="flex items-center gap-3 cursor-pointer">
                <input type="checkbox" bind:checked={form.purpura} class="checkbox checkbox-primary" />
      ...
      <div class="card bg-base-100 shadow-md border-l-4 border-base-content/30">
        <div class="card-body">
          ...
          <div class="flex flex-wrap items-center gap-4">
            <label class="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" bind:checked={form.tabac} class="checkbox checkbox-primary" />
            ...
            <label class="flex items-center gap-3 cursor-pointer">
              <input type="checkbox" bind:checked={form.alcool} class="checkbox checkbox-primary" />
